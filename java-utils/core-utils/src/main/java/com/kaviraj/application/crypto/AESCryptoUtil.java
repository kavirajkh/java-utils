...
public class AESCryptoUtil {
	private static final Logger log = LogManager.getLogger(AESCryptoUtil.class);
	/**
	 * Encrypt
	 * 
	 * @param plaintext
	...
	private byte[] EvpKDF(byte[] password, int keySize, int ivSize, byte[] salt, byte[] resultKey,
